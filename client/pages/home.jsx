...
function TopNav(props) {
  return (
    <nav className="nav static-fixed-top navbar-light justify-content-end align-items-center">
  ...
  return (
    <main className="home">
      <div className="homeWelcome">
        <p className="message">Hello, <strong>username</strong></p>
        <p className="message"><span>What are we planning today?</span></p>
        <hr />
      </div>
      ...
      <div className="text-center"><h3>Looks like you don&#39;t<br />have any trips planned!</h3></div>
      <div className="text-center"><p>Let&#39;s start planning!<br />Click the <strong>ADD</strong> button to add a trip.</p></div>
    </main>
  );
}
...
function BottomNav(props) {
  return (
    <footer className="footer static-fixed-bottom">
      <div className="text-center">
        <div className="icon add" onClick={props.onClick}>
    ...
    if (!this.props.view) {
      ...
      return (
        <div className="overlay" onClick={this.handleClickOff}>
          <div className="trip-modal" onClick={this.stopPropagation}>
            <h2>Add a trip</h2>
            <form id="tripForm" onSubmit={this.handleSubmit}>
