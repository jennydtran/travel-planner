          ...
          <div className="align-self-stretch">
            <form id="signup" className="px-3 d-flex flex-column">
              ...
              {/* <div className="form-group">
                <label className="light-teal mb-3" htmlFor="username">Username</label>
              ...
              <div className="form-group">
                <label className="light-teal mb-3" htmlFor="password">Password</label>
            ...
            {/* <div className="text-center dark-teal">
              <h5 className="font-weight-bold mt-4">Thank you</h5>
